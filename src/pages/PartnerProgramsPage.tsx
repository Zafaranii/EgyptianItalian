  ...
  return (
    <PageLayout>
      ...
      <div className="w-full h-32 flex items-end" style={{
        backgroundImage: "url('https://images.pexels.com/photos/3184465/pexels-photo-3184465.jpeg?auto=compress&cs=tinysrgb&w=1200&h=300&fit=crop')",
        ...
        <div className="container mx-auto px-4 pb-4">
          <nav className="text-sm text-white flex items-center space-x-2 bg-black/40 rounded px-3 py-2 w-fit">
            ...
            <span className="text-[#ffeb3b]">Partner Programs</span>
          </nav>
        </div>
      </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              ...
              <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <div className="h-64 bg-gradient-to-br from-[#00824a] to-[#006838] flex items-center justify-center">
                  <span className="text-white text-6xl">🤝</span>
                </div>
                <div className="p-8">
                  <h2 className="text-2xl font-bold mb-4 text-[#00824a]">Distributor Program</h2>
              ...
              <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="p-8">
                  <h2 className="text-2xl font-bold mb-4 text-[#00824a]">Operator Program</h2>
                  <p className="text-gray-600 mb-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-8 mb-16">
              <h2 className="text-3xl font-bold mb-8 text-center text-[#00824a]">Program Benefits</h2>
